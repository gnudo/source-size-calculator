...
% according to Eqs. (19) and (20) from the paper by Lovric et al.,
% Opt. Express 22, 2745 (2014). For finding the solution, we make use of
% the Newton method (http://en.wikipedia.org/wiki/Newton_method).
%--------------------------------------------------------------------------
% Date: 2014-02-28
% Author: Goran Lovric
...
sigma_H_start = sigma_H_start - del_p_H(1) ./ f_H_prime;
sigma_V_start = sigma_V_start - del_p_V(1) ./ f_V_prime;
end
...
E_start = E_start - del_p(1) ./ ff_prime;
end
